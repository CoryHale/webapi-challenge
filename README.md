...
- [X] Mention two parts of Express that you learned about this week.
    ...
    endpoints and requests? Im actually not sure what this is asking for.

- [X] Describe Middleware?

    Functions that run in between our endpoint requests to accomplish certain tasks.

- [X] Describe a Resource?

    A resource is the thing that you get to send back from the API to the client.
...
- [X] How can we partition our application into sub-applications?
    ...
    Using Router we can split our endpoints into different sub-apps.
